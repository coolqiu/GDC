...
typedef enum MAV_TYPE
{
	...
	MAV_TYPE_ECU=27, /*  Onboard engine controller | */
...
{
	MAV_COMP_ID_ALL=0, /*  | */
	MAV_COMP_ID_CAMERA=100, /* EO camera  | */
	MAV_COMP_ID_IR_CAMERA=101, /*  IR camera  | */
	MAV_COMP_ID_ON_GIMBAL_RANGE_FINDER=102, /*  Range finder on the gimbal  | */
	MAV_COMP_ID_IR_LASER_SPOTTER=105, /*  Laser spotter for target highlitings  | */
	MAV_COMP_ID_PAYLOAD_CONTROLLER=106, /*  Payload controller physycaly connected to both cameras , gimbal, laser range finder , laser spotter , videoconverter ,. | */
	MAV_COMP_ID_VIDEOCONVERTER_AND_VIDEOSVITCH=107, /*   Videoconverter  | */
	...
	MAV_COMP_ID_ECU=155, /*  Engine control unit  | */
...
typedef enum MAV_CMD
{
	...
	MAV_CMD_GIMBAL_GEO_ATTITUDE_DATA=2222,/*Gimbal target (point of viev) coordinates and attitude data*/
...
/** @brief  */
#ifndef HAVE_ENUM_ECU_ERRORS
#define HAVE_ENUM_ECU_ERRORS
typedef enum ECU_ERRORS
{
	fuel_sensor_1_alarm=1, /*  Fuel sensor 1 alarm or error  | */
	fuel_sensor_2_alarm=2, /* Fuel sensor 2 alarm or error  | */
	temp_sensor_1_alarm=4, /*  Temprature sensor 1 alarm or error  | */
	temp_sensor_2_alarm=8, /*  Temprature sensor 2 alarm or error | */
	temp_sensor_3_alarm=16, /*  Temprature sensor 3 alarm or error  | */
	engine_alarm=32, /*  Engine low RPM or stoped  | */
	fuel_flow_sensor_alarm=64, /*  Engine low RPM or stoped  | */
	generator_alarm=128, /*  Generator low voltage or overcurrent  | */
	ECU_ERRORS_ENUM_END=129, /*  | */
} ECU_ERRORS;
#endif

/** @brief  Black magic Analog to SDI miniconverter working mode  */
#ifndef HAVE_ENUM_CVBS_TO_SDI_CONVERTER_MODES
#define HAVE_ENUM_CVBS_TO_SDI_CONVERTER_MODES
typedef enum CVBS_TO_SDI_CONVERTER_MODES
{
	PROCESSING=1, /*  1 - on , 0 - off  | */
	reserved_2=2, /* Reserved  | */
	reserved_4=4, /*  Reserved  | */
	COMPOSITE_S_VIDEO_SELECTOR=8, /*  Composite or S-Video selector 0 - COMPOSITE , 1 - S-VIDEO  | */
	COMPONENT_OR_COMPOSITE_SVIDEO=16, /*  Component or composite/ s-video selector  0 - component , 1 - composite or s-video  | */
	BETACAM_LEVELS=32, /*  Signal levels  0 - SMPTE levels , 1 - BETACAM_LEVELS  | */
	IRE0_0=64, /*  IRE in USA with NTSC signals must by off - 0 ,  else on - 1  | */
	DIGITAL_AUDIO=128, /*  0 - Analog audio in , 1 AES/EBU Audio  | */
	CVBS_TO_SDI_CONVERTER_MODES_ENUM_END=129, /*  | */
} CVBS_TO_SDI_CONVERTER_MODES;
#endif

/** @brief  */
#ifndef HAVE_ENUM_RANGEFINDER_STATUS
#define HAVE_ENUM_RANGEFINDER_STATUS
typedef enum RANGEFINDER_STATUS
{
	LP=1, /*  Noptel LRF status bit LASER POWER PROBLEMS   | */
	LA=2, /*  Noptel LRF status bit LASER ACTIVE (IF CONTINOUS PULSING MODE SET)   | */
	MAD=4, /*  Noptel LRF status bit TRANSMITTER SENDING PULSES WITHOUT REQUEST   | */
	NR=8, /*  Noptel LRF status bit NOT READY (TOO HIGH REQUESTED MEASUREMENT FREQUENCY)   | */
	ERR=16, /*  Noptel LRF status bit ERROR REPORTED BY LRF  | */
	NT=32, /*  Noptel LRF status bit NO TARGETS   | */
	MT=64, /*  Noptel LRF status bit MULTIPLE TARGETS   | */
	NOT_IN_USE=128, /*  Noptel LRF status not used bit    | */
	RANGEFINDER_STATUS_ENUM_END=129, /*  | */
} RANGEFINDER_STATUS;
#endif
...
#include "./mavlink_msg_onboard_ecu_data.h"
#include "./mavlink_msg_on_gimbal_range_finder_data.h"
#include "./mavlink_msg_converter_and_switcher_mode_set.h"
#include "./mavlink_msg_payload_controller_real_time_data.h"
